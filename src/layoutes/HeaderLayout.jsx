...
export default function HeaderLayout() {
  ...
  return (
    <div className="container flex flex-row justify-around lg:items-center sm:pt-7 mobile:pt-7 md:pt-7 ">
      ...
      <div className="flex md:flex-col lg:flex-row sm:flex-col mobile:flex-col">
        ...
        <div
          className={`${
            toggle ? " flex" : " hidden"
          } lg:flex lg:ms-[20%] sm:bg-[#3b3054] md:bg-[#3b3054] md:px-28 md:py-4 mobile:rounded-b-md mobile:p-10 mobile:flex-col mobile:bg-[#3b3054] sm:rounded-b-md md:rounded-b-md    lg:bg-white  sm: mx-auto md:mx-auto  gap-2 lg:flex-row md:flex-col  sm:flex-col  p-2 sm:m-0 md:m-0 lg:mt-4 `}
        >
          <button className="font-mono font-bold text-gray-400 ">Login</button>
          <button className="bg-[#2acfcf] text-white  rounded-[30px] py-2 px-5 ">
            SingUp
          </button>
        </div>
      </div>
